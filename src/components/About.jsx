            ...
            >
                ...
                <div className="relative w-full max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        >
                            <strong className="text-[#5c21d2]">Cochin Connect</strong> — Empowering Businesses, Building Relationships
                        </motion.p>
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {benefits.map((benefit, index) => (
                                    <motion.div
                                        ...
                                        className="flex items-center gap-3 p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#8a48e7]/5 hover:to-[#5c21d2]/5 transition-all duration-300"
                                    >
                                        <CheckCircle className="w-6 h-6 text-[#8a48e7] flex-shrink-0" />
